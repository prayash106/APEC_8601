...
For this analysis, I have choosen SSP1 and SSP5 -  where SSP1 describes a future pathway with comparatively low challenges for adaptation and mitigation but SSP5, on the other hand, represents high challenges to mitigation combined with low challenges to adaptation. Basically, under SPP1 we will be seeing strong regulation to avaoid environmental tradeoffs and in case of SSP5 we will see medium regulations. These SSP are used alongside with the Representative Concentration Pathways (RCPs) to analyze the feedback between socio-economic fcators and climate chnage. In this exercise, we choose two RCPs - 2.6 and 8.5.
